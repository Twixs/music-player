...
describe('GridListComponent', () => {
  ...
  xit('should display cover image of the album if images array is NOT EMPTY', () => {
      ...
      images: [
        {
          height: 640,
          url:
            'https://i.scdn.co/image/9cc77a8f62923a063996321d437663469fbff5c6',
          width: 640,
        },
        {
          height: 300,
          url:
            'https://i.scdn.co/image/ae074701eb87c0f1512a73142658868ebc1e0f92',
          width: 300,
        },
      ],
      name: 'Fine Line',
    ...
    expect(component.getCoverImage(album)).toBe(
      'https://i.scdn.co/image/ae074701eb87c0f1512a73142658868ebc1e0f92'
    );
  });
  ...
  xit('should display no-cover image for the album if images array is EMPTY', () => {
    ...
    expect(component.getCoverImage(albumWithNoCover)).toBe(
      '../assets/no-cover.jpg'
    );
  });
});
